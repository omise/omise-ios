...
OMSSourceTypeValue const _Nonnull OMSSourceTypeValueDana = @"dana";
OMSSourceTypeValue const _Nonnull OMSSourceTypeValueGcash = @"gcash";
OMSSourceTypeValue const _Nonnull OMSSourceTypeValueKakaoPay = @"kakaopay";
OMSSourceTypeValue const _Nonnull OMSSourceTypeValueTouchNGo = @"touch_n_go";
OMSSourceTypeValue const _Nonnull OMSSourceTypeValueBillPaymentTescoLotus = @"bill_payment_tesco_lotus";
OMSSourceTypeValue const _Nonnull OMSSourceTypeValueBarcodeAlipay = @"barcode_alipay";
