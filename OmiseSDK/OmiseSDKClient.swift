...
/// A client object responsible to do card tokenization for the merchant.
@objc(OMSSDKClient) public class OmiseSDKClient: NSObject {
    ...
    /**
     OmiseSDKClient initializer
     - parameter publicKey: A merchant's public key generated by Omise
     - note: This initializer will create an NSOperationQueue and NSURLSession with ephemeral session configuration.
    ...
    /**
     OmiseSDKClient initializer
     - parameter publicKey: A merchant's public key generated by Omise
     - parameter queue: NSOperationQueue that token request callback will be called on
     - parameter session: NSURLSession using for running network request of tokenization requests.
    ...
    /**
     Send a tokenization request to Omise
    ...
    /**
     Send a tokenization request to Omise
     - parameter request: Token Request
     - parameter delegate: An `OmiseTokenRequestDelegate` object which the delegate methods will be called on.
     - seealso: OmiseTokenRequest
     - seealso: [The Omise Token API documentation](https://www.omise.co/tokens-api)
     */
