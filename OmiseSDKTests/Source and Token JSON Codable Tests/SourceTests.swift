...
class SourceTests: XCTestCase {
    ...
    func validatePayloadCodable(_ payload: Source.Payment) throws {
        ...
        let decodedPayload: Source.Payment = try parse(jsonString: encodedPayloadJson)
    ...
    func testDecodeBarcodeAlipay() throws {
        ...
        let payload = Source.Payment.BarcodeAlipay(
    ...
    func testDecodeAtome() throws {
        let payload = Source.Payment.Atome(
    ...
    func testDecodeDuitNowOBW() throws {
        ...
        let payload = Source.Payment.DuitNowOBW(bank: .affin)
        XCTAssertEqual(source.id, "src_5pqcjr6tu4xvqut5nh5")
        XCTAssertTrue(source.isLiveMode)
    ...
    func testDecodeInstallmentBay() throws {
        ...
        let payload = Source.Payment.Installment(
            installmentTerm: 6,
    ...
    func testDecodeTrueMoneyWallet() throws {
        ...
        let payload = Source.Payment.TrueMoneyWallet(phoneNumber: "0123456789")
    ...
    func testDecodeEContext() throws {
        ...
        let source: Source = try sampleFromJSONBy(.source(type: sourceType))
        let payload = Source.Payment.EContext(
            name: "ヤマダタロウ",
            email: "test@opn.com",
    ...
    func testDecodeFPX() throws {
        ...
        let source: Source = try sampleFromJSONBy(.source(type: sourceType))
        let payload = Source.Payment.FPX(
            bank: .uob,
